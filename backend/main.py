...
def main():
    ...
    processor = BookistProcessor(pdf_path ,"The Lean Startup" ,'Eric Ries', "The Lean Startup by Eric Ries is a guide to building and scaling startups efficiently. It introduces the **Build-Measure-Learn framework, emphasizing rapid experimentation, customer feedback, and iterative development over rigid planning. The book advocates for creating a **Minimum Viable Product (MVP)** to test ideas quickly, reducing waste and increasing adaptability. It’s essential reading for entrepreneurs looking to innovate with minimal risk and maximize growth.","https://cdn2.penguin.com.au/covers/original/9780670921607.jpg","Business & Entrepreneurship" )
