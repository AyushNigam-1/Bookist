...
const Overview = () => {
    ...
    return (
        <div className="flex flex-col gap-4  w-full py-4">
            ...
            <div className="flex flex-col md:flex-row relative gap-5 w-full justify-center"  >
                ...
                <div className="flex flex-col gap-6 w-full">
                    ...
                    <div className="flex gap-2 justify-between md:justify-normal w-full">
                        <button
                            type="button"
                            className="text-gray-200  bg-gradient-to-r from-gray-800 via-gray-500 to-gray-800  w-full  flex gap-2 items-center justify-center focus:outline-none rounded-lg p-2 md:w-min  font-semibold "
                        >
                        ...
                        <button
                            type="button"
                            className="text-gray-200  bg-gradient-to-r from-gray-800 via-gray-500 to-gray-800   w-full justify-center  flex gap-2 items-center  focus:outline-none rounded-lg p-2 md:w-min  font-semibold "
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                        ...
                        <Link
                            ...
                            type="button"
                            className="text-white  bg-gradient-to-r from-gray-800 via-gray-500 to-gray-800  focus:outline-none  py-3 md:py-2 px-4 rounded-lg md:w-min w-[96vw] font-semibold flex md:relative bottom-4 md:bottom-0  gap-2 items-center justify-center fixed ">
