...
export default function Page() {
    ...
    return (
        <div className="flex flex-col ">
            {mode !== "Swipe" && <div className="sticky top-0  bg-opacity-80 backdrop-blur-md z-10 py-4">
                <div className={`flex justify-between items-center`} >
                    <h4 className="lg:text-4xl font-black text-gray-700 text-2xl" >Insights</h4>
                    <SearchBar />
                ...
                {steps ? (
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4" >
                        {steps.map((step, index) => (
                            <Link href={`/step/${params.title}/${params.category}/${step.step}`} key={index} className="bg-gray-100 rounded-xl  col-span-1 p-3 flex-col flex gap-4" >
                                ...
                                <div className="flex gap-2 justify-between">
                                    <div className='flex gap-2 '>
                                        <button
                                            type="button"
                                            className="text-gray-800 bg-white  focus:outline-none rounded-full p-2 w-min  font-semibold "
                                        >
