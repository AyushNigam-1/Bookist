...
const Card: React.FC<CardProps> = ({ book }) => {
    ...
    console.log(book)
    return (
        <div className=" rounded-xl cursor-pointer overflow-clip bg-gray-200  gap-2 p-2 break-inside-avoid flex flex-col" onClick={() => {
            ...
            <div className="flex flex-col gap-4 w-full">
                <div className="relative w-full flex justify-center items-center overflow-clip rounded-xl  ">
                    ...
                    <img
                        src={book.thumbnail}
                        className="relative z-10  shadow-lg rounded-xl  object-contain"
                        alt={book.title}
                    />
                </div>
                <div className="flex flex-col gap-3 w-full justify-center">
                    ...
                    <div className="flex gap-3  flex-wrap " >
                        {book?.category.split(",").map((category: any, index: number) => {
